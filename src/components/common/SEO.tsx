 ...
 * Cette version est optimisée pour la performance, la robustesse et l'accessibilité.
 * Elle utilise le chargement différé (lazy loading) pour les sections principales,
 * des périmètres de sécurité (Error Boundaries) pour prévenir les plantages,
 * et un typage TypeScript strict pour la maintenabilité du code.
 */
...
import PageLoader from '../components/ui/PageLoader'; // Un fallback plus global pour Suspense.
...
const HomePage: React.FC = () => {
   ...
   * des données, éviter les erreurs et bénéficier de l'autocomplétion de l'éditeur.
   * Ces données aident les moteurs de recherche à comprendre notre activité
        ...
        <Suspense fallback={<PageLoader />}>
          <main>
            {/* 
              ...
              pointant vers le titre (h2) améliore grandement l'accessibilité pour
              les lecteurs d'écran, leur permettant de naviguer plus facilement dans la page.
              Cette implémentation doit être faite à l'intérieur de chaque composant de section.
              Exemple dans ClassesSection.tsx : <section aria-labelledby="classes-title">
            */}
            <Hero />
            <ClassesSection />
            <AboutSection />
